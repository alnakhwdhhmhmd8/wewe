...
{
{text = '✭ سورس جاك ✭', url = 't.me/xvwwvl '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/wwvvwl '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("wwvvwl")
...
local TestText = "*✯ مبرمج سورس جاك ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/wwvvwl"}
}
}
...
photo = "https://t.me/xvwwvl"
local T =[[
☆︙[𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 ᴊᴀᴋ](t.me/xvwwvl )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/ᴊᴀᴋ '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/wwvvwl'},
},
{
{text = '• قناة التحديثات •', url = 't.me/xvwwvl '},
},
{  
